...
1. [Modular](https://github.com/erictossell/nixflakes/blob/main/docs/screens/FlakeStructure8.png)
 (opinionated) Configuration Structure

2. Interactive build script for adding new hosts/users at [`sh/build.sh`](https://github.com/erictossell/nixflakes/blob/main/sh/build.sh)
...
4. [`eriixvim`](https://github.com/erictossell/eriixvim) is a fully reproducible neovim configuration built with [`nixvim`](https://github.com/nix-community/nixvim).
...
7. A simple example of a custom built `rust` package: [`russh`](https://github.com/erictossell/russh). The highlight being how simple it is to package any application with `flakes` and import them into a `configuration`.

8. Places I run this `flake`:
```md
